...
$('.galery__text__num-2').click(function(e){
    ...
    mySwiper.update();
    var bullets = $('.swiper-pagination-bullet');
    $('.navigation').css('max-width', count*bullets.width() + count*20 + 100);
...
$('.galery__text__num-3').click(function(e){
    ...
    mySwiper.update();
    var bullets = $('.swiper-pagination-bullet');
    $('.navigation').css('max-width', count*bullets.width() + count*20 + 80);
});
...
if (window.innerWidth >= 779 && window.innerWidth <= 1024) {
    var x;
    x = 100 - (1024 - window.innerWidth)/2.5 ;
    $('.line-dotted').css('width', x+'%');
}
